...
await writeFile(join(publicCatalogDir, 'hero-skins.json'), `${JSON.stringify(manifest.heroSkins, null, 2)}\n`, 'utf8')
await writeFile(join(publicCatalogDir, 'coins.json'), `${JSON.stringify(manifest.coins, null, 2)}\n`, 'utf8')
await writeFile(join(publicCatalogDir, 'card-backs.json'), `${JSON.stringify(manifest.cardBacks, null, 2)}\n`, 'utf8')
