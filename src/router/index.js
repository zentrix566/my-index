...
const routes = [
  ...
  { path: '/hearthstone', name: 'hearthstone-achievements', component: loadHearthstoneAchievementsPage, meta: { title: '炉石传说成就档案 | Zentrix' } },
  ...
  { path: '/hearthstone/black-market', name: 'hearthstone-black-market', component: loadBlackMarketCalculatorPage, meta: { title: '黑市血石计算器 | Zentrix' } },
  ...
  { path: '/notes', name: 'notes', component: loadNotesPage, meta: { requiresAuth: true, title: '灵感收集 | Zentrix' } },
  // ========== 历史时间线（纯本地数据，无后端依赖）==========
