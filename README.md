...
- **个人作品**（`/projects`）：与工作项目共用项目索引，把自己写的小页面和工具收拢成卡片，点卡片直接进入：
  ...
  - 日程管理（`/todo`）：轻量待办与日程，含今日计划、逾期提醒、改期记录、补记完成、今日已完成视图、自定义分组（默认 工作/学习/生活，可增删）、优先级、日历月/周视图（已完成任务按实际完成日期显示，周视图默认、周一为起始）与日程 AI 分析、今日已完成图片导出。
